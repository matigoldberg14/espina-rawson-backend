...
router.delete('/:id', authenticateToken, informationController.deleteInformation);
router.patch('/:id/toggle', authenticateToken, informationController.toggleInformationStatus);
