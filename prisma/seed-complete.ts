...
async function seedComplete() {
  ...
  const pageContents = [
    ...
    },
    {
      ...
      value: 'Más de 25 años de experiencia en subastas judiciales, brindando servicios profesionales y confiables en todo el territorio argentino.',
    ...
    },
    {
      ...
      value: 'Somos un estudio jurídico especializado en subastas judiciales con más de dos décadas de experiencia. Nuestro compromiso es brindar servicios profesionales, transparentes y eficientes.',
  ...
  const practiceAreas = [
    {
      ...
      description: 'Especialistas en la conducción de subastas judiciales de bienes inmuebles, muebles, vehículos y maquinaria industrial.',
      icon: 'gavel',
      order: 1
    },
    {
      title: 'Asesoramiento Legal',
      description: 'Brindamos asesoramiento integral en procesos judiciales, ejecuciones y procedimientos concursales.',
      icon: 'scale',
      order: 2
    },
    {
      title: 'Tasaciones',
      description: 'Realizamos tasaciones profesionales de bienes para procesos judiciales y extrajudiciales.',
      icon: 'calculator',
      order: 3
    },
    {
      title: 'Gestión de Cobros',
      description: 'Especialistas en gestión y recupero de créditos mediante procedimientos judiciales y extrajudiciales.',
      icon: 'credit-card',
      order: 4
    }
  ];
  ...
  const auctions = [
    {
      ...
      description: 'Hermoso departamento de 2 ambientes en el corazón de Palermo. Excelente ubicación, cerca de transporte público y centros comerciales.',
      type: 'inmuebles',
      ...
      order: 1,
      mainImageUrl: 'https://images.unsplash.com/photo-1560518883-ce09059eeffa?w=800&h=600&fit=crop',
      pdfUrl: 'https://example.com/departamento-palermo.pdf'
    },
    {
      title: 'Casa en San Isidro',
      description: 'Casa familiar de 4 ambientes con jardín. Ideal para familias, ubicada en zona residencial tranquila.',
      type: 'inmuebles',
      ...
      status: AuctionStatus.PUBLISHED,
      order: 2,
      mainImageUrl: 'https://images.unsplash.com/photo-1564013799919-ab600027ffc6?w=800&h=600&fit=crop',
      pdfUrl: 'https://example.com/casa-san-isidro.pdf'
    },
    {
      title: 'Oficina Comercial Microcentro',
      description: 'Oficina comercial en edificio corporativo. Excelente para inversión o uso propio.',
      type: 'inmuebles',
      ...
      status: AuctionStatus.PUBLISHED,
      order: 3,
      mainImageUrl: 'https://images.unsplash.com/photo-1497366216548-37526070297c?w=800&h=600&fit=crop',
  ...
  const informationData = [
    {
      ...
      description: 'Todo lo que necesitas saber sobre el proceso de subastas judiciales en Argentina, desde la presentación hasta la adjudicación.',
    ...
    },
    {
      ...
      description: 'Tutorial paso a paso sobre cómo participar correctamente en una subasta judicial.',
    ...
    },
    {
      ...
      description: 'Imágenes de propiedades subastadas exitosamente y testimonios de clientes satisfechos.',
