  ...
  const practiceAreas = await Promise.all([
    prisma.practiceArea.create({
      data: {
        ...
        description: 'Asesoramiento integral en procesos de crisis, reestructuraciones de deuda, concursos preventivos y quiebras.',
        icon: 'Shield',
        order: 1,
        isActive: true,
      },
    ...
    prisma.practiceArea.create({
      data: {
        ...
        description: 'Representación en disputas judiciales y extrajudiciales de alta complejidad a nivel nacional e internacional.',
        icon: 'Scale',
        order: 2,
        isActive: true,
      },
    ...
    prisma.practiceArea.create({
      data: {
        ...
        description: 'Gestión completa del proceso de subasta, desde la tasación hasta la liquidación final de activos.',
        icon: 'Gavel',
        order: 3,
        isActive: true,
      },
    ...
    prisma.practiceArea.create({
      data: {
        ...
        description: 'Asesoramiento en fusiones, adquisiciones, gobierno corporativo y estructuración de negocios.',
        icon: 'Briefcase',
        order: 4,
        isActive: true,
      },
    ...
    prisma.practiceArea.create({
      data: {
        title: 'Real Estate',
        description: 'Consultoría en desarrollos inmobiliarios, fideicomisos y estructuración de inversiones en bienes raíces.',
        icon: 'Building',
        order: 5,
        isActive: true,
      },
    ...
    prisma.practiceArea.create({
      data: {
        ...
        description: 'Especialización en la valoración y liquidación de plantas industriales, maquinaria y líneas de producción.',
        icon: 'Factory',
        order: 6,
        isActive: true,
      },
  ...
  const studioContent = await Promise.all([
    prisma.studioContent.create({
      data: {
        section: 'hero',
        title: 'El Estudio',
        subtitle: 'Tradición, innovación y un compromiso inquebrantable con la excelencia.',
        content: 'Fundado en 1968, nuestro estudio nació con la vocación de ofrecer un servicio legal de máxima calidad, especializado en los desafíos más complejos del derecho comercial.',
    ...
    prisma.studioContent.create({
      data: {
        ...
        content: 'Hemos tenido el privilegio de asesorar a empresas líderes en diversos sectores de la industria. Nuestra trayectoria y resultados hablan por sí mismos, estableciendo relaciones de confianza duraderas con nuestros clientes.',
        order: 3,
        isActive: true,
      },
    }),
    prisma.studioContent.create({
      data: {
        ...
        subtitle: 'El mayor activo de nuestra firma es el talento y la dedicación',
        content: 'El mayor activo de nuestra firma es el talento y la dedicación de nuestros profesionales. Cada miembro del equipo aporta experiencia única y compromiso con la excelencia.',
        order: 4,
        isActive: true,
      },
    }),
    prisma.studioContent.create({
      data: {
        ...
        content: 'Un enfoque multidisciplinario para ofrecer soluciones integrales y estratégicas a los desafíos legales más exigentes. Nuestra experiencia abarca desde derecho concursal hasta fusiones y adquisiciones.',
        order: 5,
        isActive: true,
      },
    }),
