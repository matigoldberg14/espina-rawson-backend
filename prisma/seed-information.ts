  ...
  const informationData = [
    {
      ...
      description: 'Todo lo que necesitas saber sobre el proceso de subastas judiciales en Argentina, desde la presentación hasta la adjudicación. Incluye requisitos, documentación necesaria y pasos a seguir.',
    ...
    },
    {
      ...
      description: 'Tutorial paso a paso sobre cómo participar correctamente en una subasta judicial. Aprende sobre los requisitos, documentación y procedimientos necesarios.',
    ...
    },
    {
      ...
      description: 'Imágenes de propiedades subastadas exitosamente y testimonios de clientes satisfechos. Conoce nuestros casos más destacados.',
    ...
    },
    {
      ...
      description: 'Artículo detallado sobre los derechos y obligaciones que adquiere el comprador en una subasta judicial. Información legal esencial.',
      type: InformationType.ARTICLE,
    ...
    },
    {
      ...
      description: 'Grabación de nuestro webinar sobre cómo invertir inteligentemente en subastas inmobiliarias. Estrategias y consejos de expertos.',
      type: InformationType.VIDEO,
      url: 'https://www.youtube.com/watch?v=dQw4w9WgXcQ',
    ...
    },
    {
      ...
      description: 'Transformaciones impresionantes de propiedades adquiridas en subastas. Ver el potencial de cada inversión.',
      type: InformationType.IMAGE,
