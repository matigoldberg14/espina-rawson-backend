...
import { Plus, Edit, Trash2, Eye, EyeOff, FileText, Image, Type } from 'lucide-react';
...
const SECTION_OPTIONS = [
  { value: 'hero', label: 'Hero Principal', description: 'Título y subtítulo principal de la página' },
  { value: 'history', label: 'Historia del Estudio', description: 'Sección de historia y fundación' },
  { value: 'clients_intro', label: 'Introducción a Clientes', description: 'Texto introductorio de la sección de clientes' },
  { value: 'about_intro', label: 'Introducción Sobre Nosotros', description: 'Texto introductorio de la sección sobre nosotros' },
  { value: 'practice_intro', label: 'Introducción Áreas de Práctica', description: 'Texto introductorio de las áreas de práctica' },
];
...
const StudioContentPage: React.FC = () => {
  ...
  const [editingContent, setEditingContent] = useState<StudioContent | null>(null);
  ...
  const handleToggleActive = async (content: StudioContent) => {
    try {
      ...
      if (response.ok) {
        toast({
          title: "Éxito",
          description: `Contenido del estudio ${!content.isActive ? 'activado' : 'desactivado'} correctamente`,
        });
        fetchStudioContent();
      } else {
    ...
    return (
      <div className="flex items-center justify-center min-h-screen">
        <div className="text-center">
          ...
          <p className="mt-4 text-muted-foreground">Cargando contenido del estudio...</p>
        </div>
      </div>
    );
  }
    ...
    <div className="container mx-auto p-6">
      <div className="flex justify-between items-center mb-6">
        <div>
          ...
          <p className="text-muted-foreground">Gestiona el contenido estático del estudio</p>
        </div>
              ...
              <div className="flex items-start justify-between">
                <div className="flex-1">
                  <div className="flex items-center gap-3 mb-3">
                    ...
                    <div>
                      <h3 className="text-lg font-semibold">{getSectionLabel(content.section)}</h3>
                      <p className="text-sm text-muted-foreground">{getSectionDescription(content.section)}</p>
                    </div>
                  </div>
                  ...
                  {content.subtitle && (
                    <div className="mb-2">
                      <span className="text-sm font-medium text-muted-foreground">Subtítulo:</span>
                  ...
                  <div className="mb-2">
                    ...
                    <p className="text-base text-muted-foreground">{content.content}</p>
                  </div>
                  ...
                  <div className="flex items-center gap-4 mt-3 text-sm text-muted-foreground">
                    ...
                    <span>Estado: {content.isActive ? 'Activo' : 'Inactivo'}</span>
                    ...
                    <AlertDialogContent>
                      <AlertDialogHeader>
                        ...
                        <AlertDialogDescription>
                          Esta acción no se puede deshacer. Se eliminará permanentemente el contenido del estudio.
                        </AlertDialogDescription>
                      </AlertDialogHeader>
                      <AlertDialogFooter>
      ...
      <Dialog open={isCreateDialogOpen} onOpenChange={setIsCreateDialogOpen}>
        <DialogContent className="max-w-3xl">
          <DialogHeader>
            <DialogTitle>
              {editingContent ? 'Editar Contenido del Estudio' : 'Nuevo Contenido del Estudio'}
            </DialogTitle>
          </DialogHeader>
